      ...
      steps:
        ...
        - doTry:
            ...
            steps:
              - setProperty:
                  ...
                  expression:
                    simple:
                      id: simple-1c7c
                      expression: >-
                        api.e-unicred.com.br/homolog/cobranca/v2/beneficiarios/${exchangeProperty.bancoDadosEspecificos[idBeneficiario]}/titulos
              - setHeaders:
                  id: setHeaders-09b2
                  headers:
                    - id: setHeader-376a
                    ...
                    - id: setHeader-a7a6
                      ...
                      expression:
                        simple:
                          id: simple-784c
                          expression: >-
                            ${exchangeProperty.bancoDadosEspecificos[cooperativa]}
                    - id: setHeader-403b
                      name: apiKey
                      expression:
                        simple:
              ...
              - log:
                  id: log-4efb
                  message: ${exchangeProperty.idBoleto}
              - doTry:
                  id: doTry-4e04
                  doCatch:
                    - id: doCatch-66ff
                    ...
                    - setProperty:
                        ...
                        expression:
                          simple:
                            id: simple-ac4b
                            expression: >-
                              api.e-unicred.com.br/homolog/cobranca/v2/beneficiarios/${exchangeProperty.bancoDadosEspecificos[idBeneficiario]}/titulos/${exchangeProperty.idBoleto}/status
                    - setHeaders:
                        id: setHeaders-40d0
                        headers:
                          - id: setHeader-7e11
